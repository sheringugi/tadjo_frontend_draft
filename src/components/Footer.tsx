    ...
    <footer className="bg-foreground text-background">
      ...
      <div className="border-b border-background/10"> 
        <div className="container mx-auto py-16">
          <div className="max-w-lg mx-auto text-center">
            <h3 className="text-2xl font-display mb-3">{t('footer.newsletterHeading')}</h3>
      ...
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          {/* Shop */}
          <div>
            <h4 className="text-xs tracking-luxury uppercase mb-6">{t('footer.shopHeading')}</h4>
           ...
           {/* About */}
          <div>
            <h4 className="text-xs tracking-luxury uppercase mb-6">{t('footer.aboutHeading')}</h4>
            <ul className="space-y-3">
              <li><Link to="/about" className="text-sm text-background/60 hover:text-background transition-colors">{t('footer.aboutOurStory')}</Link></li>
              ...
              <li><Link to="/contact" className="text-sm text-background/60 hover:text-background transition-colors">{t('footer.aboutContact')}</Link></li>
            </ul>
          </div>
          
          {/* Help */}
          <div>
            <h4 className="text-xs tracking-luxury uppercase mb-6">{t('footer.helpHeading')}</h4>
            <ul className="space-y-3">
              <li><Link to="/returns" className="text-sm text-background/60 hover:text-background transition-colors">{t('footer.helpReturns')}</Link></li>
              <li><Link to="/contact" className="text-sm text-background/60 hover:text-background transition-colors">{t('footer.helpContact')}</Link></li>
              <li><Link to="/wishlist" className="text-sm text-background/60 hover:text-background transition-colors">{t('footer.helpWishlist')}</Link></li>
            </ul> 
